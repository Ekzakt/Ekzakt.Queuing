...
public class QueueServiceAzure : IQueueService
{
    private readonly ILogger<QueueServiceAzure> _logger;
    private readonly QueueServiceClient _queueServiceClient;

    private QueueClient? _queueClient;


    public QueueServiceAzure(
        ILogger<QueueServiceAzure> logger,
